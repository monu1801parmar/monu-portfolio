...
export const Projects = () => {
  return (
    ...
    <div id='education'className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 items-center text-center mx-auto mt-8'>
  <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mx-auto">
    <a href="#">
        <img class="rounded-t-lg" src={Portfolio_image} alt="" />
    </a>
    <div class="p-5">
        <a href="#">
...
<div class="max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="rounded-t-lg" src={Bookstore_image } alt="" />
    </a>
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
