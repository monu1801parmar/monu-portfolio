...
export const About = () => {
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <a
      href="#contact"
      className="inline-block mt-8 px-6 py-3 text-lg font-semibold text-[#0A192F] bg-[#64ffda] rounded-lg shadow-md transition duration-300 hover:bg-[#52e0c1] hover:-translate-y-1"
    >
      Let's Connect
    </a>
  </div>
